...
helm install onix-bap ./helm/microservice/api -f ./helm/microservice/api/values-bap.yaml

# Or install with custom values
helm install onix-bap ./helm/microservice/api -f ./helm/microservice/api/values-bap.yaml --set image.tag=v1.0.0
```
...
```bash
# Install with default values
helm install onix-bpp ./helm/microservice/api -f ./helm/microservice/api/values-bpp.yaml

# Or install with custom values
helm install onix-bpp ./helm/microservice/api -f ./helm/microservice/api/values-bpp.yaml --set image.tag=v1.0.0
```
...
```bash
helm install onix-bap ./helm/microservice/api \
  -f ./helm/microservice/api/values-bap.yaml \
...
helm upgrade onix-bap ./helm/microservice/api \
  -f ./helm/microservice/api/values-bap.yaml \
...
- For RabbitMQ integration: See [Helm Microservice RabbitMQ](./../rabbitmq/README.md)
- For Kafka integration: See [Helm Microservice Kafka](./../kafka/README.md)
- For monolithic architecture: See [Helm Monolithic API](./../../monolithic/api/README.md)
