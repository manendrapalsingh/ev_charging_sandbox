...
In a microservice architecture with Kafka, the onix-adapter uses Apache Kafka for high-throughput event streaming. Each adapter consists of two modules that work together to handle bidirectional communication between BAP and BPP applications through Kafka topics.
...
- **Onix-Adapter Services**: BAP and BPP adapters with Kafka integration
- **Event-Based Communication**: Topic-based message streaming

## Directory Structure

```
docker/microservice/kafka/
...
- **Microservice Architecture**: Each endpoint can route to different services
...
- For RabbitMQ integration: See [Microservice RabbitMQ](./../rabbitmq/README.md)
- For API integration: See [Microservice API](./../api/README.md)
- For monolithic architecture: See [Monolithic Kafka](./../../monolithic/kafka/README.md)
